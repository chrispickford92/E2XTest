 ...
 */
export declare function totpGenerate(options: TotpGenerateOptions): string;
/**
 ...
 */
export declare function totpVerifyDelta(options: VerifyOptions): VerifyDelta;
/**
 ...
 */
export declare function totpVerify(options: VerifyOptions): boolean;
/**
 ...
 */
export declare function counter(options: CounterOptions): number;

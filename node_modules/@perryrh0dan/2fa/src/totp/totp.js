...
exports.counter = exports.totpVerify = exports.totpVerifyDelta = exports.totpGenerate = void 0;
const hotp_1 = require("../hotp/hotp");
/**
 ...
 */
function totpVerifyDelta(options) {
    // unpack options
    ...
    var delta = hotp_1.hotpVerifyDelta(opts);
    // adjust for two-sided window
    if (delta) {
        delta.delta -= window;
    }
